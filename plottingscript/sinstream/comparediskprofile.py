...
def plotvalues(gamma, start, end, dir, color, label, ax0, ax1, ax2, ax3):
    ...
    ax1.plot(rad_avg, AMkep, lw=1.0, c=color, ls=':')
    ax1.set_ylabel(r"AM")
    ax1.set_xlabel(r"R")
...
fig.suptitle(r"t=120-150", fontsize=15)
...
plotvalues(1.1,150,120,'/LyraShared/xh2pm/BinaryDisk_prep/inflow/highres_adiabatic/stampede/gamma11_hlle_new/', 'r', r'circular potential', ax0, ax1, ax2, ax3)
plotvalues(1.1,150,120,'/LyraShared/xh2pm/BinaryDisk_prep/inflow/sinstream/g11ecc_fixstream/', 'b', r'ecc=0.2 potential', ax0, ax1, ax2, ax3)
plotvalues(1.1,150,120,'/LyraShared/xh2pm/BinaryDisk_prep/inflow/sinstream/g11ecc_hr/', 'g', r'ecc=0.2 potential+sinstream', ax0, ax1, ax2, ax3)


plt.savefig("avg_150120.png")
#plt.show()
